...
![PCA - How It Works](images_pca/01_pca_how_it_works.png)
...
![Feature Engineering vs PCA](images_pca/04_feature_engineering_vs_pca.png)
...
![PCA 3D to 2D](images_pca/03_pca_3d_to_2d.png)

*PCA can reduce a 3D dataset to 2D while keeping the clusters clearly separated!*

![PCA Scree Plot - Explained Variance](images_pca/02_pca_scree_plot.png)
